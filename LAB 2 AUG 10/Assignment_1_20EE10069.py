...
# IMP NOTE - 1 : Due to implementation of "PERCEPTRON" instead of KNeighboursClassifier for K Fold Cross Validation using 2000 iterations, the code is running little slow.
...
# Creating a list of different K_values
K_values = [2, 4, 7, 8]
